...
经过更多的账号尝试，发现不用在严格的`指纹浏览器`和`全局模式`下才能完成家庭组邀请，只需要使用来自英国的 ip 地址即可。
...
1. 不能是教育版批量注册的账号，教育版账号无权限做很多事情。
2. 被邀请进入家庭组的账号必须是 gmail 个人账号。
3. 拉取别的账号时，对方账号的`地理位置信息`，必须和主账号的`付款地址信息`，保持同一个 ip。
