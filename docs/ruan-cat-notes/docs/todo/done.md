...
## 让 github action + vercel 实现有意义的 pnpm 单仓部署 <Badge type="tip" text="已完成" />
...
## 全面替换这个过时的 cdn 代理商 <Badge type="tip" text="已完成" />
...
## 给 awesome-yami 写一个 pr <Badge type="tip" text="已完成" />
...
## 制作便于查询 stars 的网站 <Badge type="tip" text="已完成" />
...
## 配置 deepwiki 的 badge 实现每周自动重新索引 AI 阅读报告 <Badge type="tip" text="已完成" />
