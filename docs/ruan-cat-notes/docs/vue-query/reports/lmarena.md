...
- **GitHub**: [https://github.com/Hebilicious/vue-query-nuxt](https://github.com/Hebilicious/vue-query-nuxt)
...
- **GitHub**: [https://github.com/ozum/nuxt-vue-query](https://github.com/ozum/nuxt-vue-query)
...
- **GitHub**: [https://github.com/who-jonson/sakai-nuxt](https://github.com/who-jonson/sakai-nuxt)
...
- **GitHub**: [https://github.com/adminmart/Modernize-nuxtjs-free](https://github.com/adminmart/Modernize-nuxtjs-free)
- **描述**: 开发者友好的响应式管理仪表板模板
...
- **GitHub**: [https://github.com/WailanTirajoh/nuxt3-admin-template](https://github.com/WailanTirajoh/nuxt3-admin-template)
...
- **GitHub**: [https://github.com/randymxd07/TanStack_Vue_Query](https://github.com/randymxd07/TanStack_Vue_Query)
...
- **GitHub**: [https://github.com/brandonroberts/vite-nitro-vue](https://github.com/brandonroberts/vite-nitro-vue)
...
- **GitHub**: [https://github.com/DamianOsipiuk/vue-query](https://github.com/DamianOsipiuk/vue-query)
...
- [Vue Query 专属文档](https://tanstack.com/query/latest/docs/vue/overview)
- [官方示例集合](https://tanstack.com/query/latest/docs/vue/examples/simple)

### 🎥 视频教程

- [Vue Query 入门教程](https://www.youtube.com/results?search_query=tanstack+vue+query)
- [Nuxt 3 + Vue Query 实战](https://www.youtube.com/results?search_query=nuxt+3+vue+query)

### 💬 社区支持

- [GitHub Discussions](https://github.com/TanStack/query/discussions)
- [Discord 服务器](https://discord.com/invite/WrRKjPJ)
- [Stack Overflow](https://stackoverflow.com/questions/tagged/vue-query)
...
_📝 文档生成时间: 2024-12-11_

_💡 提示: 建议收藏本文档，定期查看更新_
