...
目前（2025-10-8）还不知道确切的项目代号。

本次项目代号为`12psi进销存项目`。

自我介绍，糕鸭果阮喵喵，也可以简称为`阮喵喵`。这是我第五次参加 01 星球的大项目了。

非计算机专业。知识储备不够广阔，除了纯前端的知识以外，其他的后端知识、服务器知识、软件工程知识都很欠缺。

## 项目周期

2025 年 10 月 11 日 - 2025 年 11 月 13 日
